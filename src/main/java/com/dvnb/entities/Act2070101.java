...
/**
 * The persistent class for the DVNB_ACT_2070101 database table.
 * Tiếp nhận và xử lý tra soát, tranh chấp, bồi hoàn giao dịch thẻ quốc tế do SCB phát hành
 * Input file GSTS_019.xlsx
 */
@Entity
@Table(name = "DVNB_ACT_2070101")
@NamedQuery(name = "Act2070101.findAll", query = "SELECT f FROM Act2070101 f")
public class Act2070101 implements Serializable {
