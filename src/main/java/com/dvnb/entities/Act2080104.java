...
/**
 * The persistent class for the DVNB_ACT_2080104 database table.
 */
@Entity
@Table(name = "DVNB_ACT_2080104")
@NamedQuery(name = "Act2080104.findAll", query = "SELECT f FROM Act2080104 f")
public class Act2080104 implements Serializable {
