...
/**
 * The persistent class for the DVNB_ACT_2100301 database table.
 * Tiếp nhận và xử lý tra soát, tranh chấp, bồi hoàn giao dịch thẻ quốc tế do SCB phát hành
 * Input file ACT_2100301.xlsx
 */
@Entity
@Table(name = "DVNB_ACT_2100301")
@NamedQuery(name = "Act2100301.findAll", query = "SELECT f FROM Act2100301 f")
public class Act2100301 implements Serializable {
