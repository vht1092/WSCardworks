...
/**
 * The persistent class for the DVNB_ACT_2080201 database table.
 * Input file GSTS_017.xlsx
 */
@Entity
@Table(name = "DVNB_ACT_2080201")
@NamedQuery(name = "Act2080201.findAll", query = "SELECT f FROM Act2080201 f")
public class Act2080201 implements Serializable {
	...
	@Column(name = "THOI_GIAN_GIAO_DICH", nullable = false, length = 20)
