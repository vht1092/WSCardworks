...
/**
 * The persistent class for the DVNB_ACT_2110203 database table.
 * Tiếp nhận và xử lý tra soát, tranh chấp, bồi hoàn giao dịch thẻ quốc tế do SCB phát hành
 */
@Entity
@Table(name = "DVNB_ACT_2110203")
@NamedQuery(name = "Act2110203.findAll", query = "SELECT f FROM Act2110203 f")
public class Act2110203 implements Serializable {
