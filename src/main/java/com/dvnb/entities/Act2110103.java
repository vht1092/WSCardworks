...
/**
 * The persistent class for the DVNB_ACT_2110103 database table.
 * Tiếp nhận và xử lý tra soát, tranh chấp, bồi hoàn giao dịch thẻ quốc tế do SCB phát hành
 * Input file ACT_2110103.xlsx
 */
@Entity
@Table(name = "DVNB_ACT_2110103")
@NamedQuery(name = "Act2110103.findAll", query = "SELECT f FROM Act2110103 f")
public class Act2110103 implements Serializable {
	...
	@Column(name = "SO_HO_SO", nullable = false, length = 30)
