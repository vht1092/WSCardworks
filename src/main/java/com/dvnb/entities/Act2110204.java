...
/**
 * The persistent class for the DVNB_ACT_2110204 database table.
 * Tiếp nhận và xử lý tra soát, tranh chấp, bồi hoàn giao dịch thẻ quốc tế do SCB phát hành
 */
@Entity
@Table(name = "DVNB_ACT_2110204")
@NamedQuery(name = "Act2110204.findAll", query = "SELECT f FROM Act2110204 f")
public class Act2110204 implements Serializable {
