...
/**
 * The persistent class for the DVNB_ACT_2070102 database table.
 * Tiếp nhận và xử lý tra soát, tranh chấp, bồi hoàn giao dịch thẻ quốc tế do SCB phát hành
 * Input file ACT_2070102.xlsx
 */
@Entity
@Table(name = "DVNB_ACT_2070102")
@NamedQuery(name = "Act2070102.findAll", query = "SELECT f FROM Act2070102 f")
public class Act2070102 implements Serializable {
	...
	@Column(name = "TEN_CHU_THE", nullable = false, length = 120)
	private String tenChuThe;
	
	@Column(name = "CIF", nullable = false, length = 19)
	private String cif;
	
	@Column(name = "SO_THE", nullable = false, length = 22)
