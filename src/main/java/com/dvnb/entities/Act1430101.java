...
/**
 * The persistent class for the DVNB_ACT_1430101 database table.
 */
@Entity
@Table(name = "DVNB_ACT_1430101")
@NamedQuery(name = "Act1430101.findAll", query = "SELECT f FROM Act1430101 f")
public class Act1430101 implements Serializable {
