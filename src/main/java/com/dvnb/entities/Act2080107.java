...
/**
 * The persistent class for the DVNB_ACT_2080107 database table.
 * Tiếp nhận và xử lý tra soát, tranh chấp, bồi hoàn giao dịch thẻ quốc tế do SCB phát hành
 */
@Entity
@Table(name = "DVNB_ACT_2080107")
@NamedQuery(name = "Act2080107.findAll", query = "SELECT f FROM Act2080107 f")
public class Act2080107 implements Serializable {
