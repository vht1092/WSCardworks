...
/**
 * The persistent class for the DVNB_ACT_2110104 database table.
 * Tiếp nhận và xử lý tra soát, tranh chấp, bồi hoàn giao dịch thẻ quốc tế do SCB phát hành
 * Input file ACT_2110104.xlsx
 */
@Entity
@Table(name = "DVNB_ACT_2110104")
@NamedQuery(name = "Act2110104.findAll", query = "SELECT f FROM Act2110104 f")
public class Act2110104 implements Serializable {
