...
/**
 * The persistent class for the DVNB_ACT_2080106 database table.
 * Input file GSTS_014.xlsx
 */
@Entity
@Table(name = "DVNB_ACT_2080106")
@NamedQuery(name = "Act2080106.findAll", query = "SELECT f FROM Act2080106 f")
public class Act2080106 implements Serializable {
	...
	@Column(name = "MA_NGHIEP_VU", nullable = false, length = 100)
