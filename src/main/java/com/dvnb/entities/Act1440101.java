...
/**
 * The persistent class for the DVNB_ACT_1440101 database table.
 */
@Entity
@Table(name = "DVNB_ACT_1440101")
@NamedQuery(name = "Act1440101.findAll", query = "SELECT f FROM Act1440101 f")
public class Act1440101 implements Serializable {
