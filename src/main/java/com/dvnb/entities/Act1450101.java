...
/**
 * The persistent class for the DVNB_ACT_1450101 database table.
 */
@Entity
@Table(name = "DVNB_ACT_1450101")
@NamedQuery(name = "Act1450101.findAll", query = "SELECT f FROM Act1450101 f")
public class Act1450101 implements Serializable {
