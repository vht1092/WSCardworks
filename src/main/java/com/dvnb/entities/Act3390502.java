...
@Entity
@Table(name = "DVNB_ACT_3390502")
@NamedQuery(name = "Act3390502.findAll", query = "SELECT f FROM Act3390502 f")
public class Act3390502 implements Serializable {
	...
	@Column(name = "LOAI_NGHIEP_VU", nullable = false, length = 100)
