...
/**
 * The persistent class for the DVNB_ACT_1450201 database table.
 */
@Entity
@Table(name = "DVNB_ACT_1450201")
@NamedQuery(name = "Act1450201.findAll", query = "SELECT f FROM Act1450201 f")
public class Act1450201 implements Serializable {
