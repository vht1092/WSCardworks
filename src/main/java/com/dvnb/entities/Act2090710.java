...
/**
 * The persistent class for the DVNB_ACT_2090710 database table.
 * Tiếp nhận và xử lý tra soát, tranh chấp, bồi hoàn giao dịch thẻ quốc tế do SCB phát hành
 */
@Entity
@Table(name = "DVNB_ACT_2090710")
@NamedQuery(name = "Act2090710.findAll", query = "SELECT f FROM Act2090710 f")
public class Act2090710 implements Serializable {
