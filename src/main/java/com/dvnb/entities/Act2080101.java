...
/**
 * The persistent class for the DVNB_ACT_2080101 database table.
 * Input file GSTS_010.xlsx
 */
@Entity
@Table(name = "DVNB_ACT_2080101")
@NamedQuery(name = "Act2080101.findAll", query = "SELECT f FROM Act2080101 f")
//@NamedStoredProcedureQueries(value= {
//        @NamedStoredProcedureQuery(name= "GetErpMappingByLOC", procedureName= "FPT.GET_ERP_MAPPING_BY_LOC", parameters= {
//                @StoredProcedureParameter(mode= ParameterMode.IN, name= "p_loc", type= String.class),
//                @StoredProcedureParameter(mode= ParameterMode.OUT, name= "sys_cursor", type= Cursor.class)
//        })
//})
public class Act2080101 implements Serializable {
