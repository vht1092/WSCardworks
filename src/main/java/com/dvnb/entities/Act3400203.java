...
/**
 * The persistent class for the DVNB_ACT_3400203 database table.
 * Tiếp nhận và xử lý tra soát, tranh chấp, bồi hoàn giao dịch thẻ quốc tế do SCB phát hành
 * Input file ACT_3400203.xlsx
 */
@Entity
@Table(name = "DVNB_ACT_3400203")
@NamedQuery(name = "Act3400203.findAll", query = "SELECT f FROM Act3400203 f")
public class Act3400203 implements Serializable {
