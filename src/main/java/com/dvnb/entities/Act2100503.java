...
/**
 * The persistent class for the DVNB_ACT_2100503 database table.
 * Tiếp nhận và xử lý tra soát, tranh chấp, bồi hoàn giao dịch thẻ quốc tế do SCB phát hành
 */
@Entity
@Table(name = "DVNB_ACT_2100503")
@NamedQuery(name = "Act2100503.findAll", query = "SELECT f FROM Act2100503 f")
public class Act2100503 implements Serializable {
