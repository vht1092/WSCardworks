...
@Entity
@Table(name = "DVNB_ACT_3390201")
@NamedQuery(name = "Act3390201.findAll", query = "SELECT f FROM Act3390201 f")
public class Act3390201 implements Serializable {
	...
	@Column(name = "HAN_MUC", nullable = false, length = 20)
