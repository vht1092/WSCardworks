...
/**
 * The persistent class for the DVNB_ACT_2080301 database table.
 * Tiếp nhận và xử lý tra soát, tranh chấp, bồi hoàn giao dịch thẻ quốc tế do SCB phát hành
 * Input file ACT_2080301.xlsx
 */
@Entity
@Table(name = "DVNB_ACT_2080301")
@NamedQuery(name = "Act2080301.findAll", query = "SELECT f FROM Act2080301 f")
public class Act2080301 implements Serializable {
