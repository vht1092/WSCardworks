...
/**
 * The persistent class for the DVNB_ACT_3390301 database table.
 * Tiếp nhận và xử lý tra soát, tranh chấp, bồi hoàn giao dịch thẻ quốc tế do SCB phát hành
 * Input file ACT_3390301.xlsx
 */
@Entity
@Table(name = "DVNB_ACT_3390301")
@NamedQuery(name = "Act3390301.findAll", query = "SELECT f FROM Act3390301 f")
public class Act3390301 implements Serializable {
	...
	@Column(name = "DON_VI_YEU_CAU_TRINH", nullable = false, length = 200)
	private String donViYeuCauTrinh;
	...
	public String getDonViYeuCauTrinh() {
		return donViYeuCauTrinh;
	}

	public void setDonViYeuCauTrinh(String donViYeuCauTrinh) {
		this.donViYeuCauTrinh = donViYeuCauTrinh;
	}
