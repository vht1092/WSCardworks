...
/**
 * The persistent class for the DVNB_ACT_2100401 database table.
 * Tiếp nhận và xử lý tra soát, tranh chấp, bồi hoàn giao dịch thẻ quốc tế do SCB phát hành
 */
@Entity
@Table(name = "DVNB_ACT_2100401")
@NamedQuery(name = "Act2100401.findAll", query = "SELECT f FROM Act2100401 f")
public class Act2100401 implements Serializable {
