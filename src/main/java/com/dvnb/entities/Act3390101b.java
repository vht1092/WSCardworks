...
@Entity
@Table(name = "DVNB_ACT_3390101b")
@NamedQuery(name = "Act3390101b.findAll", query = "SELECT f FROM Act3390101b f")
public class Act3390101b implements Serializable {
	...
	@Column(name = "PHONG_YEU_CAU", nullable = false, length = 200)
	private String phongYeuCau;
	
	@Column(name = "LOAI_THE", nullable = false, length = 20)
	...
	public String getPhongYeuCau() {
		return phongYeuCau;
	}

	public void setPhongYeuCau(String phongYeuCau) {
