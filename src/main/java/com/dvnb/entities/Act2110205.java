...
/**
 * The persistent class for the DVNB_ACT_2110205 database table.
 * Tiếp nhận và xử lý tra soát, tranh chấp, bồi hoàn giao dịch thẻ quốc tế do SCB phát hành
 */
@Entity
@Table(name = "DVNB_ACT_2110205")
@NamedQuery(name = "Act2110205.findAll", query = "SELECT f FROM Act2110205 f")
public class Act2110205 implements Serializable {
