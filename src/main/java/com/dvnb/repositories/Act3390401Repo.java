...
@Repository
public interface Act3390401Repo extends JpaRepository<Act3390401, String> {
	
	

	Page<Act3390401> findAll(Pageable page);
	
	Page<Act3390401> findAllByKy(@Param("ky") String ky, Pageable page);
	...
	@Modifying
	@Query(value = "MERGE Into DVNB_ACT_3390401 a USING IR121@IM b    " + 
