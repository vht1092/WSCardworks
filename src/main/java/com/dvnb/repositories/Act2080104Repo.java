...
@Repository
public interface Act2080104Repo extends JpaRepository<Act2080104, String> {
	
	Page<Act2080104> findAll(Pageable page);
	
	Page<Act2080104> findAllByKy(@Param("ky") String ky, Pageable page);
