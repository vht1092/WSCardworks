...
@Repository
public interface Act2070104Repo extends JpaRepository<Act2070104, String> {
	
	Page<Act2070104> findAll(Pageable page);
	
	Page<Act2070104> findAllByKy(@Param("ky") String ky, Pageable page);
	
	@Modifying
	@Query(value = "MERGE Into DVNB_ACT_2070104 a USING DVNB_DVCNT b  " + 
