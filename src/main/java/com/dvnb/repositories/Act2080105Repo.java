...
@Repository
public interface Act2080105Repo extends JpaRepository<Act2080105, String> {

	Page<Act2080105> findAll(Pageable page);
	
	Page<Act2080105> findAllByKy(@Param("ky") String ky, Pageable page);
	
	@Modifying
	@Query(value = "MERGE Into dvnb_act_2080105 a " + 
