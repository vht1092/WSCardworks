...
@Repository
public interface Act2100301Repo extends JpaRepository<Act2100301, String> {
	
	Page<Act2100301> findAll(Pageable page);
	
	Page<Act2100301> findAllByKy(@Param("ky") String ky, Pageable page);
	
	@Modifying
	@Query(value = "MERGE Into dvnb_act_2100301 a USING DVNB_ERP b " + 
