...
@Repository
public interface Act2070101Repo extends JpaRepository<Act2070101, String> {
	
	

	Page<Act2070101> findAll(Pageable page);
	
	Page<Act2070101> findAllByKy(@Param("ky") String ky, Pageable page);
