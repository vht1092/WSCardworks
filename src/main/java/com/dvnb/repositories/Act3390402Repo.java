...
@Repository
public interface Act3390402Repo extends JpaRepository<Act3390402, String> {
	
	

	Page<Act3390402> findAll(Pageable page);
	
	Page<Act3390402> findAllByKy(@Param("ky") String ky, Pageable page);
	...
	@Modifying
	@Query(value = "MERGE Into DVNB_ACT_3390402 a USING IR121@IM b    " + 
