...
@Repository
public interface Act3390801Repo extends JpaRepository<Act3390801, String> {
	
	

	Page<Act3390801> findAll(Pageable page);
	
	Page<Act3390801> findAllByKy(@Param("ky") String ky, Pageable page);
	...
	@Modifying
	@Query(value = "MERGE Into DVNB_ACT_3390801 a USING IR121@IM b    " + 
