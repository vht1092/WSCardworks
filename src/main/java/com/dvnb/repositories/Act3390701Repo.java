...
@Repository
public interface Act3390701Repo extends JpaRepository<Act3390701, String> {
	
	

	Page<Act3390701> findAll(Pageable page);
	
	Page<Act3390701> findAllByKy(@Param("ky") String ky, Pageable page);
	...
	@Modifying
	@Query(value = "MERGE Into DVNB_ACT_3390701 a USING IR121@IM b    " + 
